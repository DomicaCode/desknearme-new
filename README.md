...
pull_requests will be triggered when someone in your repository performs a pull request, this will deploy your code to MPKIT_URL_PR instance, and tests will be executed.
